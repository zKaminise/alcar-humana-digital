...
import alimentosBebidasHero from '@/assets/alimentos-bebidas-hero.jpg';
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="relative h-[500px] bg-gradient-to-r from-black/80 to-black/60 overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(${alimentosBebidasHero})` }}
        />
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center">
          <div className="text-white max-w-3xl">
            ...
            <p className="text-xl md:text-2xl leading-relaxed">
              Expertise em qualidade, segurança alimentar e inovação para impulsionar sua marca no mercado competitivo
            </p>
          </div>
        </div>
      </div>
